...
public class Units {
    ...
    public static String timeToString(long t, TimeUnit sizeUnit) {
        return timeToString(t, sizeUnit, null);
    }
     ...
     */
    public static String timeToString(long t, TimeUnit timeUnit, Collection<TimeUnit> timeUnitsToExclude) {
        if (t < 0) {
